...
class Atri:
	def __init__(self, state: Any):
		...
		self.Header_Flex2 = state["Header_Flex2"]
		self.Div5 = state["Div5"]
		self.Flex3 = state["Flex3"]
		self.Header_TextBox2 = state["Header_TextBox2"]
	...
	@property
	def Header_Flex2(self):
		self._getter_access_tracker["Header_Flex2"] = {}
		return self._Header_Flex2
	@Header_Flex2.setter
	def Header_Flex2(self, new_state):
		self._setter_access_tracker["Header_Flex2"] = {}
		global default_state
		self._Header_Flex2 = Flex(new_state, default_state["Header_Flex2"])
	...
	@property
	def Header_TextBox2(self):
		self._getter_access_tracker["Header_TextBox2"] = {}
		return self._Header_TextBox2
	@Header_TextBox2.setter
	def Header_TextBox2(self, new_state):
		self._setter_access_tracker["Header_TextBox2"] = {}
		global default_state
		self._Header_TextBox2 = TextBox(new_state, default_state["Header_TextBox2"])
	...
	def _to_json_fields(self):
		return {
			"Header_Flex2": self._Header_Flex2,
			"Div5": self._Div5,
			"Flex3": self._Flex3,
			"Header_TextBox2": self._Header_TextBox2,
			"Link17": self._Link17,
			"Link20": self._Link20,
			"Link21": self._Link21,
